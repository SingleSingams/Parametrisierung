...
8. Nutze AUSSCHLIESSLICH den im Nutzerprompt eingefügten VO-Klartext. Ignoriere jede
   Demo-, Beispiel- oder Muster-VO aus früheren Konversationen. Werte, die nicht
   aus diesem Dokument belegbar sind, bleiben null — niemals „typische“ Platzhalter
